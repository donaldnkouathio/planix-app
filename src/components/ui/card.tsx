...
export default function Card({ title, description, icon }: ICardProps) {
  ...
  return (
    <MotionCard className="h-full flex flex-col items-start text-start space-y-3 p-4 bg-white dark:bg-primary/30 rounded-lg shadow-lg hover:scale-105 transition-all duration-300">
